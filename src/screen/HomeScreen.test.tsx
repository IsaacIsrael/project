...
import { describeEventScreen, describeRenderScreen, describeScreen } from '@test/describeApp';
import renderWithProviders from '@test/renderWithProviders';
import { fireEvent, screen, waitFor, within } from '@testing-library/react-native';

jest.mock('@services/openURLInBrowser', () => jest.fn());

describeScreen('Home', () => {
  describeRenderScreen(
    () => {
      test('hero', () => {
      ...
      test('style link', () => {
        ...
        expect(
          sectionContent.getByText('Covers how to use the prop named style which controls the visuals.'),
        ).toBeTruthy();
      });
      test('layout link', () => {
        renderWithProviders(<HomeScreen />);
    ...
    {
      android: () => {
        test('see your changes section when', () => {
          renderWithProviders(<HomeScreen />);
        ...
        test('debug section', () => {
          ...
          expect(
            sectionContent.getByText('Press Cmd or Ctrl + M or Shake your device to open the Dev Menu.'),
          ).toBeTruthy();
      ...
      ios: () => {
        test('see your changes section', () => {
          renderWithProviders(<HomeScreen />);
          const seeYourChangesSection = screen.getByTestId('see-your-changes');
          const seeYourChangesSectionContent = within(seeYourChangesSection!);

          expect(
            seeYourChangesSectionContent.getByText("Press Cmd + R in the simulator to reload your app's code."),
          ).toBeTruthy();

          const rText = seeYourChangesSectionContent.getByText('Cmd + R');
