const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./react-18-Bo8EaXyA.js","./index-DEsPWUIh.js","./index-CHK4WJUA.js","./client-Cd3u0B9u.js","./index-CvUaxwb9.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./iframe-CHGnGNgx.js";
import { _ as __toESM, a as __commonJS, d as __export } from "./react-CNLXb6_6.js";
import { r as reactExports, R as React } from "./index-DEsPWUIh.js";
import { r as requireReact } from "./index-CHK4WJUA.js";
...
function requireReactDomTestUtils_production_min() {
  ...
  var k = requireReact(), l = requireReactDom();
  function m(a) {
    var b = a, c = a;
...
var hasRequiredTestUtils;
function requireTestUtils() {
  if (hasRequiredTestUtils) return testUtils.exports;
  hasRequiredTestUtils = 1;
  {
    testUtils.exports = requireReactDomTestUtils_production_min();
  }
  return testUtils.exports;
}
requireTestUtils();
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await __vitePreload(async () => {
    const { renderElement: renderElement2, unmountElement: unmountElement2 } = await import("./react-18-Bo8EaXyA.js");
    return { renderElement: renderElement2, unmountElement: unmountElement2 };
  }, true ? __vite__mapDeps([0,1,2,3,4]) : void 0, import.meta.url), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? React.createElement(Story, { ...storyContext }) : React.createElement(ErrorBoundary, { showMain, showException }, React.createElement(Story, { ...storyContext })), element = Wrapper ? React.createElement(Wrapper, null, content) : content;
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
  ...
  try {
    let { configure } = await __vitePreload(async () => {
      const { configure: configure2 } = await import("./react-CNLXb6_6.js").then((n) => n.r);
